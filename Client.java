...
public class Client{
	...
	public static void main(String[] args) throws UnknownHostException, IOException {
        ...
        long timeOut;
        for (timeOut = 300L; timeOut < 50000L; timeOut *= 2){
            ...
            System.err.println("Timeout="+ timeOut+", transferring took " + (endTime - startTime) + " milliseconds");
            socket.close();
            lastAck = 0;
        }
	}
